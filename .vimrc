...
autocmd FileType typescriptreact setlocal shiftwidth=2 tabstop=2 expandtab colorcolumn=80
autocmd FileType typescript setlocal shiftwidth=2 tabstop=2 expandtab colorcolumn=80
